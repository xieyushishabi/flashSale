...
const hashFunction = zod_1.z.enum(["md4", "xxhash64"]);
const hashSalt = zod_1.z.string();
const sourceMapFilename = zod_1.z.string();
const devtoolNamespace = zod_1.z.string();
const devtoolModuleFilenameTemplate = zod_1.z.union([
    zod_1.z.string(),
...
const baseResolveOptions = zod_1.z.strictObject({
    ...
    aliasFields: zod_1.z.array(zod_1.z.string()).optional(),
    restrictions: zod_1.z.array(zod_1.z.string()).optional(),
    roots: zod_1.z.array(zod_1.z.string()).optional()
});
...
const ruleSetRules = zod_1.z.array(zod_1.z.literal("...").or(ruleSetRule).or(falsy));
...
const optimization = zod_1.z.strictObject({
    ...
    providedExports: zod_1.z.boolean().optional(),
    concatenateModules: zod_1.z.boolean().optional(),
