...
var e2c = __nccwpck_require__(823)

var BrowserslistError = __nccwpck_require__(22)
var parse = __nccwpck_require__(751)
var env = __nccwpck_require__(522) // Will load browser.js in webpack
...
module.exports = {
  loadQueries: function loadQueries(ctx, name) {
    ...
    var queries = require(__nccwpck_require__(85).resolve(name, { paths: ['.', ctx.path] }))
    if (queries) {
  ...
  loadStat: function loadStat(ctx, name, data) {
    ...
    var stats = require(__nccwpck_require__(85).resolve(
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(397);
