import type { ArrayOrNot, ChainedConfigCombineUtils, ChainedConfigWithUtils } from '../utils';
...
type ChainedHtmlOption<O> = ChainedConfigCombineUtils<O, {
    entryName: string;
}>;
export interface HtmlConfig {
     ...
     */
    templateParameters?: ChainedConfigWithUtils<Record<string, unknown>, {
        entryName: string;
    }>;
    /**
