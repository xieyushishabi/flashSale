...
export type ToolsPostCSSLoaderConfig = ChainedConfigWithUtils<PostCSSLoaderOptions, {
...
export type ToolsHtmlPluginConfig = ChainedConfigWithUtils<HTMLPluginOptions, {
    entryName: string;
...
export type ToolsRspackConfig = ChainedConfigWithUtils<RspackConfig, ModifyRspackConfigUtils>;
