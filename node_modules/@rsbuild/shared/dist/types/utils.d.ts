...
export type ChainedConfig<Config> = ArrayOrNot<Config | ((config: Config) => Config | void)>;
export type ChainedConfigWithUtils<Config, Utils> = ArrayOrNot<Config | ((config: Config, utils: Utils) => Config | void)>;
export type ChainedConfigCombineUtils<Config, Utils> = ArrayOrNot<Config | ((params: {
    value: Config;
} & Utils) => Config | void)>;
