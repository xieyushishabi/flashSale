...
const getSharedPkgCompiledPath = (packageName) => import_node_path.default.join(__dirname, "../compiled", packageName);
...
const ensureAbsolutePath = (base, filePath) => import_node_path.default.isAbsolute(filePath) ? filePath : import_node_path.default.resolve(base, filePath);
const castArray = (arr) => {
  if (arr === void 0) {
    return [];
  }
...
const applyToCompiler = (compiler, apply) => {
...
const onCompileDone = (compiler, onDone, MultiStatsCtor) => {
  if (isMultiCompiler(compiler)) {
